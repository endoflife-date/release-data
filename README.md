...
As of 2024-06-19, 244 of the 310 products tracked by endoflife.date have automatically tracked releases:
...
| Kubernetes Node Feature Discovery             | [`/kubernetes-node-feature-discovery`](https://endoflife.date/kubernetes-node-feature-discovery)       | ✔️   | git                            |
